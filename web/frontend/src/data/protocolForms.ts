  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'p_razmer', label: 'Размер — толщина', type: 'number', unit: 'мм' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'dp_dlina', label: 'Длина', type: 'number', unit: 'мм' },
        { key: 'dp_tolshina', label: 'Толщина', type: 'number', unit: 'мм' },
        { key: 'dp_shirina', label: 'Ширина', type: 'number', unit: 'мм' },
        { key: 'dp_obem', label: 'Объём', type: 'number', unit: 'см³' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'dl_dlina', label: 'Длина', type: 'number', unit: 'мм' },
        { key: 'dl_tolshina', label: 'Толщина', type: 'number', unit: 'мм' },
        { key: 'dl_shirina', label: 'Ширина', type: 'number', unit: 'мм' },
        { key: 'dl_obem', label: 'Объём', type: 'number', unit: 'см³' },
    ...
    },
    {
      ...
      fields: [
        { key: 'summarniy', label: 'Суммарный объём', type: 'number', unit: 'см³', hint: 'у мужчин 7.7–25, у женщин 4.4–18' },
        { key: 'kg', label: 'Вес пациента', type: 'number', unit: 'кг' },
        { key: 'sm', label: 'Объём железы в норме у пациента составляет', type: 'number', unit: 'см³' },
      ],
    },
    {
      title: 'Заключение',
