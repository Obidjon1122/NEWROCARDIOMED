export interface FormField {
  key: string;
  label: string;
  type: 'number' | 'combobox' | 'textarea' | 'text';
  defaultValue?: string;
  unit?: string;
  hint?: string;
  options?: string[];
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'pech_pzr_lev', label: 'ПЗР левой доли', type: 'number', unit: 'мм', hint: 'в норме 41–62' },
        { key: 'pech_kkr_lev', label: 'ККР левой доли', type: 'number', unit: 'мм', hint: 'в норме 65–110' },
        { key: 'pech_pzr_hvost', label: 'ПЗР хвостатой доли', type: 'number', unit: 'мм', hint: 'в норме 25–30' },
        { key: 'pech_pzr_prav', label: 'ПЗР правой доли', type: 'number', unit: 'мм', hint: 'в норме 91–140' },
        { key: 'pech_kkr_prav', label: 'ККР правой доли', type: 'number', unit: 'мм', hint: 'в норме до 145' },
        { key: 'pech_kvr', label: 'КВР', type: 'number', unit: 'мм', hint: 'в норме 17–22.2 см' },
        { key: 'pech_lat_razmer', label: 'Латерально-латеральный размер', type: 'number', unit: 'см', hint: 'в норме 17–25' },
        ...
        { key: 'pech_obem', label: 'Объём печени', type: 'number', unit: 'см³', hint: 'в норме 700–2000' },
        { key: 'pech_massa', label: 'Масса печени', type: 'number', unit: 'г' },
    ...
    },
    {
      title: 'Сосуды',
      fields: [
        { key: 'soud_pech_veny', label: 'Долевые печёночные вены диаметром', type: 'number', unit: 'мм', hint: 'в норме до 9–11' },
        { key: 'soud_sum_diam', label: 'Суммарный диаметр', type: 'number', unit: 'мм', hint: 'в норме 27–31' },
        { key: 'soud_port_vena', label: 'Портальная вена', type: 'number', unit: 'мм', hint: 'в норме до 14' },
        { key: 'soud_nizhnyaya_pv', label: 'Нижняя полая вена', type: 'number', unit: 'мм', hint: 'в норме 20–25' },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: 'zhp_obshchiy', label: 'Общий желчный проток', type: 'number', unit: 'мм', hint: 'в норме 4–6' },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: 'puz_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 40–100' },
        { key: 'puz_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 10–40' },
        { key: 'puz_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 20–50' },
        { key: 'puz_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме 8–42' },
        { key: 'puz_ploshad', label: 'Площадь по длиннику', type: 'number', unit: 'см²', hint: 'в норме 15–18' },
        { key: 'puz_protok', label: 'Пузырный проток', type: 'combobox', defaultValue: 'не визуализируется', options: NE_VIZ },
        { key: 'puz_stenka', label: 'Толщина стенки', type: 'number', unit: 'мм', hint: 'в норме до 3, у перешейка до 4' },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'prav_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 75–130' },
        { key: 'prav_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 35–50' },
        { key: 'prav_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 45–65' },
        { key: 'prav_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме до 134' },
        { key: 'prav_parenhima_t', label: 'Толщина паренхимы', type: 'number', unit: 'мм', hint: 'в норме 8–25' },
        ...
        { key: 'prav_chls_tolshina', label: 'Состояние ЧЛС — толщина', type: 'number', unit: 'мм' },
        ...
        { key: 'prav_kri', label: 'Кортико-ренальный индекс', type: 'number', hint: 'в норме 0.34–0.40' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'lev_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 75–130' },
        { key: 'lev_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 35–50' },
        { key: 'lev_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 45–65' },
        { key: 'lev_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме до 146' },
        { key: 'lev_parenhima_t', label: 'Толщина паренхимы', type: 'number', unit: 'мм', hint: 'в норме 8–25' },
        ...
        { key: 'lev_chls_tolshina', label: 'Состояние ЧЛС — толщина', type: 'number', unit: 'мм' },
        ...
        { key: 'lev_kri', label: 'Кортико-ренальный индекс', type: 'number', hint: 'в норме 0.34–0.40' },
    ...
    },
    {
      ...
      fields: [
        { key: 'mp_obem', label: 'Объём', type: 'number', unit: 'мл', hint: 'в норме 150–200' },
        ...
        { key: 'mp_stenka_do', label: 'Толщина стенки до опорожнения', type: 'number', unit: 'мм', hint: 'в норме 3–6' },
        { key: 'mp_stenka_posle', label: 'Толщина стенки после опорожнения', type: 'number', unit: 'мм', hint: 'в норме до 8' },
        ...
        { key: 'mp_ostatoch', label: 'Объём остаточной мочи', type: 'number', unit: 'мл', hint: 'в норме до 20 мл' },
      ],
    },
    {
      title: 'Заключение',
  ...
  sections: [
    {
      title: 'Перешеек',
      fields: [
        { key: 'per_topografia', label: 'Топография', type: 'combobox', defaultValue: 'в норме', options: TOPOGR, hint: 'в норме на уровне 1–2 хрящевых колец трахеи' },
        { key: 'per_kontur', label: 'Контур', type: 'combobox', defaultValue: 'в норме', options: KONTUR },
        { key: 'per_elastichnost', label: 'Эластичность', type: 'combobox', defaultValue: 'в норме', options: ['в норме', 'снижена', 'повышена'] },
        { key: 'per_podvizhnost', label: 'Глотательная подвижность', type: 'combobox', defaultValue: 'в норме', options: ['в норме', 'ограничена', 'отсутствует'] },
        { key: 'per_tolshina', label: 'Размер — толщина', type: 'number', unit: 'мм' },
        { key: 'per_exostruktura', label: 'Эхоструктура', type: 'combobox', defaultValue: 'однородная', options: EHOGSTR },
        { key: 'per_exogennost', label: 'Эхогенность', type: 'combobox', defaultValue: 'средняя', options: EHOGEN_SR },
      ],
    },
    {
      title: 'Правая доля',
      fields: [
        { key: 'prav_topografia', label: 'Топография', type: 'combobox', defaultValue: 'в норме', options: TOPOGR },
        { key: 'prav_kontur', label: 'Контур', type: 'combobox', defaultValue: 'в норме', options: KONTUR },
        { key: 'prav_elastichnost', label: 'Эластичность', type: 'combobox', defaultValue: 'сохранена', options: ['сохранена', 'снижена'] },
        { key: 'prav_podvizhnost', label: 'Глотательная подвижность', type: 'combobox', defaultValue: 'в норме', options: ['в норме', 'ограничена'] },
        { key: 'prav_dlina', label: 'Длина', type: 'number', unit: 'мм' },
        { key: 'prav_tolshina', label: 'Толщина', type: 'number', unit: 'мм' },
        { key: 'prav_shirina', label: 'Ширина', type: 'number', unit: 'мм' },
        { key: 'prav_obem', label: 'Объём', type: 'number', unit: 'см³' },
        { key: 'prav_forma', label: 'Форма', type: 'combobox', defaultValue: 'в норме', options: FORMA_VN, hint: 'в норме треугольная, цилиндрическая' },
        { key: 'prav_exostruktura', label: 'Эхоструктура', type: 'combobox', defaultValue: 'однородная', options: EHOGSTR },
        { key: 'prav_exogennost', label: 'Эхогенность', type: 'combobox', defaultValue: 'средняя', options: EHOGEN_SR },
      ],
    },
    {
      title: 'Левая доля',
      fields: [
        { key: 'lev_topografia', label: 'Топография', type: 'combobox', defaultValue: 'в норме', options: TOPOGR },
        { key: 'lev_kontur', label: 'Контур', type: 'combobox', defaultValue: 'в норме', options: KONTUR },
        { key: 'lev_elastichnost', label: 'Эластичность', type: 'combobox', defaultValue: 'в норме', options: ['в норме', 'снижена'] },
        { key: 'lev_podvizhnost', label: 'Глотательная подвижность', type: 'combobox', defaultValue: 'сохранена', options: ['сохранена', 'ограничена'] },
        { key: 'lev_dlina', label: 'Длина', type: 'number', unit: 'мм' },
        { key: 'lev_tolshina', label: 'Толщина', type: 'number', unit: 'мм' },
        { key: 'lev_shirina', label: 'Ширина', type: 'number', unit: 'мм' },
        { key: 'lev_obem', label: 'Объём', type: 'number', unit: 'см³' },
        { key: 'lev_forma', label: 'Форма', type: 'combobox', defaultValue: 'в норме', options: FORMA_VN, hint: 'в норме треугольная, цилиндрическая' },
        { key: 'lev_exostruktura', label: 'Эхоструктура', type: 'combobox', defaultValue: 'однородная', options: EHOGSTR },
        { key: 'lev_exogennost', label: 'Эхогенность', type: 'combobox', defaultValue: 'средняя', options: EHOGEN_SR },
      ],
    },
    {
      title: 'Суммарный объём',
      fields: [
        { key: 'sum_obem', label: 'Суммарный объём', type: 'number', unit: 'см³', hint: 'у мужчин 7.7–25, у женщин 4.4–18' },
        { key: 'obem_pri_vese', label: 'Объём железы в норме у пациента составляет', type: 'number', unit: 'см³' },
      ],
    },
    {
      title: 'Заключение',
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'pdj_golovka', label: 'Толщина головки', type: 'number', unit: 'мм', hint: 'в норме 11–32' },
        { key: 'pdj_telo', label: 'Толщина тела', type: 'number', unit: 'мм', hint: 'в норме 4–21' },
        { key: 'pdj_hvost', label: 'Толщина хвоста', type: 'number', unit: 'мм', hint: 'в норме 7–35' },
        { key: 'pdj_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 80–125' },
        ...
        { key: 'pdj_virsungov_g', label: 'Вирсунгов проток — область головки', type: 'number', unit: 'мм', hint: 'в норме 3–4' },
        { key: 'pdj_virsungov_t', label: 'Вирсунгов проток — область тела', type: 'number', unit: 'мм', hint: 'в норме 1–2' },
      ],
    },
    {
      title: 'Заключение',
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'sel_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 90–130' },
        { key: 'sel_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 30–50' },
        { key: 'sel_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 50–80' },
        { key: 'sel_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме 80–300' },
        { key: 'sel_indeks', label: 'Селезёночный индекс', type: 'number', unit: 'см²', hint: 'в норме 13.5–32.5' },
        ...
        { key: 'sel_lienalis', label: 'v. lienalis', type: 'number', unit: 'мм', hint: 'в норме 4–7' },
      ],
    },
    {
      title: 'Заключение',
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'pr_kapsul_t', label: 'Капсула, толщина', type: 'number', unit: 'мм', hint: 'в норме 1–2' },
        { key: 'pr_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 24–41' },
        { key: 'pr_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 16–25' },
        { key: 'pr_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 27–43' },
        { key: 'pr_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме не более 20–25' },
        { key: 'pr_indeks', label: 'Индекс конфигурации простаты', type: 'number', hint: 'в норме не более 0.829' },
        ...
        { key: 'pr_nach_obem', label: 'Начальный объём мочевого пузыря', type: 'number', unit: 'мл' },
        { key: 'pr_ostatoch', label: 'Остаточная моча', type: 'number', unit: 'мл', hint: 'в норме до 20 мл или не более 10%' },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: 'svp_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме до 50' },
        { key: 'svp_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме до 15' },
        { key: 'svp_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме до 20' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'svl_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме до 50' },
        { key: 'svl_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме до 15' },
        { key: 'svl_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме до 20' },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'prm_kozha_t', label: 'Кожа — толщина', type: 'number', unit: 'мм', hint: 'в норме до 3' },
        ...
        { key: 'prm_podkozh_t', label: 'Подкожная жировая ткань — толщина', type: 'number', unit: 'мм' },
        { key: 'prm_intramam', label: 'Интрамаммарная жировая ткань', type: 'combobox', defaultValue: 'без особенностей', options: BEZ_OSB },
        { key: 'prm_retromam_t', label: 'Ретромаммарная жировая ткань — толщина', type: 'number', unit: 'мм' },
        { key: 'prm_parenhima_kontur', label: 'Паренхима — контур', type: 'combobox', defaultValue: 'в норме', options: KONTUR },
        { key: 'prm_parenhima_t', label: 'Паренхима — толщина', type: 'number', unit: 'мм' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'levm_kozha_t', label: 'Кожа — толщина', type: 'number', unit: 'мм', hint: 'в норме до 3' },
        ...
        { key: 'levm_podkozh_t', label: 'Подкожная жировая ткань — толщина', type: 'number', unit: 'мм' },
        { key: 'levm_intramam', label: 'Интрамаммарная жировая ткань', type: 'combobox', defaultValue: 'без особенностей', options: BEZ_OSB },
        { key: 'levm_retromam_t', label: 'Ретромаммарная жировая ткань — толщина', type: 'number', unit: 'мм' },
        { key: 'levm_parenhima_kontur', label: 'Паренхима — контур', type: 'combobox', defaultValue: 'в норме', options: KONTUR },
        { key: 'levm_parenhima_t', label: 'Паренхима — толщина', type: 'number', unit: 'мм' },
  ...
  sections: [
    {
      title: 'Мочевой пузырь',
      fields: [
        { key: 'mp_obem_fiz', label: 'Объём физиологический', type: 'number', unit: 'мл', hint: 'в норме 150–200' },
        ...
        { key: 'mp_ostatoch', label: 'Объём остаточной мочи', type: 'number', unit: 'мл', hint: 'в норме до 20 мл или до 10% от исходного' },
      ],
    },
    {
      title: 'Заключение',
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'mat_den_cikla', label: 'День менструального цикла', type: 'number' },
        ...
        { key: 'mat_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 42–70' },
        { key: 'mat_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 33–46' },
        { key: 'mat_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 42–60' },
        { key: 'mat_obem', label: 'Объём матки', type: 'number', unit: 'см³', hint: 'в норме 30–100' },
        ...
        { key: 'mat_endo_t', label: 'Толщина эндометрия (М-эхо)', type: 'number', unit: 'мм', hint: 'зависит от дня цикла, не более 18' },
    ...
    },
    {
      title: 'Шейка матки',
      fields: [
        { key: 'sheika_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 20–40' },
        { key: 'sheika_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 30–35' },
        { key: 'sheika_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 30–40' },
        ...
        { key: 'sheika_endo_t', label: 'Толщина эндоцервикса', type: 'number', unit: 'мм', hint: 'в норме 2–5' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'yach_pr_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 20–45' },
        { key: 'yach_pr_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 15–25' },
        { key: 'yach_pr_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 20–30' },
        { key: 'yach_pr_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме 5–8, до 11' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'yach_lev_dlina', label: 'Длина', type: 'number', unit: 'мм', hint: 'в норме 20–45' },
        { key: 'yach_lev_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 15–25' },
        { key: 'yach_lev_shirina', label: 'Ширина', type: 'number', unit: 'мм', hint: 'в норме 20–30' },
        { key: 'yach_lev_obem', label: 'Объём', type: 'number', unit: 'см³', hint: 'в норме 5–8, до 11' },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'npr_prodolniy', label: 'Продольный размер', type: 'number', unit: 'мм', hint: 'в норме 45' },
        { key: 'npr_poperechniy', label: 'Поперечный размер', type: 'number', unit: 'мм', hint: 'в норме 16–28' },
        { key: 'npr_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 5–6' },
        { key: 'npr_ploshad', label: 'Площадь', type: 'number', unit: 'см²', hint: 'в норме до 5.56' },
        { key: 'npr_giper_indeks', label: 'Индекс гиперплазии', type: 'number', hint: 'в норме не более 1.2' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'nlev_prodolniy', label: 'Продольный размер', type: 'number', unit: 'мм', hint: 'в норме 45' },
        { key: 'nlev_poperechniy', label: 'Поперечный размер', type: 'number', unit: 'мм', hint: 'в норме 16–28' },
        { key: 'nlev_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме 5–6' },
        { key: 'nlev_ploshad', label: 'Площадь', type: 'number', unit: 'см²', hint: 'в норме до 6.17' },
        { key: 'nlev_giper_indeks', label: 'Индекс гиперплазии', type: 'number', hint: 'в норме не более 1.4' },
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'kol_svyaz_tolshina', label: 'Толщина', type: 'number', unit: 'мм', hint: 'в норме не более 6' },
    ...
    },
    {
      ...
      fields: [
        { key: 'kol_zhidk_tolshina', label: 'Толщина суставной жидкости', type: 'number', unit: 'мм', hint: 'в норме 3–5' },
        ...
        { key: 'kol_sus_shel', label: 'Толщина суставной щели', type: 'number', unit: 'мм', hint: 'в норме не менее 3.5' },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: 'kol_hyalin_tolshina', label: 'Толщина', type: 'number', unit: 'мм' },
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'tri1_mat_dlina', label: 'Длина матки', type: 'number', unit: 'мм' },
        { key: 'tri1_mat_tolshina', label: 'Толщина матки', type: 'number', unit: 'мм' },
        { key: 'tri1_mat_shirina', label: 'Ширина матки', type: 'number', unit: 'мм' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'tri1_plod_diam', label: 'Средний диаметр плодного яйца', type: 'number', unit: 'мм' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'tri1_emb_ktr', label: 'КТР эмбриона', type: 'number', unit: 'мм' },
        ...
        { key: 'tri1_emb_chss', label: 'ЧСС', type: 'number', unit: 'уд/мин', hint: 'в норме 6–8 нед.: 110–130, 9–10 нед.: до 200' },
        { key: 'tri1_emb_vp', label: 'Толщина воротникового пространства', type: 'number', unit: 'мм', hint: 'в норме до 3' },
        ...
        { key: 'tri1_emb_zhel_diam', label: 'Диаметр желточного мешочка', type: 'number', unit: 'мм' },
      ],
    },
    {
      title: 'Хорион',
      fields: [
        ...
        { key: 'tri1_hor_t', label: 'Толщина хориона', type: 'number', unit: 'мм', hint: 'в норме соответствует сроку в неделях' },
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'plod_chss', label: 'ЧСС', type: 'number', unit: 'уд/мин', hint: 'в норме 115–160, до 22 нед. — до 180' },
      ],
    },
    {
      title: 'Фетометрия',
      fields: [
        { key: 'plod_bpd', label: 'Бипариетальный размер (БПР)', type: 'number', unit: 'мм' },
        { key: 'plod_bpd_srok', label: 'БПР соответствует сроку', type: 'text', hint: 'нед. дней' },
        { key: 'plod_lor', label: 'Лобно-затылочный размер (ЛЗР)', type: 'number', unit: 'мм' },
        { key: 'plod_lor_srok', label: 'ЛЗР соответствует сроку', type: 'text', hint: 'нед. дней' },
        { key: 'plod_cefal', label: 'Цефалический индекс', type: 'number', unit: '%', hint: 'в норме 71–87%' },
        { key: 'plod_bedro', label: 'Длина бедренной кости', type: 'number', unit: 'мм' },
        { key: 'plod_bedro_srok', label: 'Бедренная кость соответствует сроку', type: 'text', hint: 'нед. дней' },
        { key: 'plod_okr_golova', label: 'Окружность головки', type: 'number', unit: 'мм' },
        { key: 'plod_okr_golova_srok', label: 'Окружность головки соответствует сроку', type: 'text', hint: 'нед. дней' },
        { key: 'plod_okr_zhivot', label: 'Окружность живота', type: 'number', unit: 'мм' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'plac_tolshina', label: 'Толщина плаценты', type: 'number', unit: 'мм', hint: 'в норме 20–40' },
    ...
    },
    {
      ...
      fields: [
        { key: 'vodi_iazh', label: 'ИАЖ', type: 'number', hint: 'нормоводие' },
        ...
        { key: 'plod_massa', label: 'Масса плода', type: 'number', unit: 'г' },
  ...
  sections: [
    {
      title: 'Параметры',
      fields: [
        { key: 'serd_plod_diam', label: 'Средний диаметр плодного яйца', type: 'number', unit: 'мм' },
        { key: 'serd_plod_srok', label: 'Плодное яйцо соответствует сроку беременности', type: 'text', hint: 'нед. дней' },
        { key: 'serd_ktr', label: 'КТР эмбриона', type: 'number', unit: 'мм' },
        ...
        { key: 'serd_chss', label: 'ЧСС', type: 'number', unit: 'уд/мин' },
        { key: 'serd_zhel_diam', label: 'Желточный мешочек диаметром', type: 'number', unit: 'мм' },
      ],
    },
    {
      title: 'Заключение',
  ...
  sections: [
    {
      title: 'Параметры',
      fields: [
        { key: 'fol_den_cikla', label: 'День менструального цикла', type: 'number' },
        { key: 'fol_endo_t', label: 'Толщина эндометрия (М-эхо)', type: 'number', unit: 'мм', hint: 'зависит от дня цикла, не более 18' },
